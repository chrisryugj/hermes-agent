...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    if agent.valid_tool_names and any(
        name.startswith("mcp_korean_law_") for name in agent.valid_tool_names
    ):
        from agent.prompt_builder import KOREAN_LAW_MCP_GUIDANCE
        stable_parts.append(KOREAN_LAW_MCP_GUIDANCE)
